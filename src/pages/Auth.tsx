...
import { signIn, signUp, resetPassword, signInWithGoogle } from "@/lib/supabase-helpers";
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4">
      <div className="flex flex-col items-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-foreground">CommParse Pro</h1>
        <p className="text-muted-foreground mt-1">Parse, analyze, and extract insights from communications</p>
      </div>
      ...
      <p className="mt-8 text-xs text-muted-foreground text-center max-w-sm">
        By continuing, you agree to CommParse Pro's Terms of Service and Privacy Policy.
      </p>
    </div>
  );
};
